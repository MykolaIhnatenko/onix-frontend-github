...
const eLearningsQuoteList:IQuotesObjData[] = [
  {
    id: 1,
    ...
    + 'in production. The work Onix has been doing on this front-end React skills is clearly starting to pay off.”',
    author: (
      <>
...
export default eLearningsQuoteList;
