...
function MotionGraphicsFaqData() {
        ...
        content: (
          <div>
            <ContentText tag="p" className={textStyle}>
              ...
              {' '}
              Our team will be happy to discuss your specific needs, provide a personalized quote, and guide you through
              the process of creating compelling and impactful motion graphics for your business.
            </ContentText>
          </div>
        ),
      },
