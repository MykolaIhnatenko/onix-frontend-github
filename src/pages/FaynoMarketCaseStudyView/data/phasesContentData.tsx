...
const phasesContentData: IAccordionData[] = [
  {
    id: 1,
    number: '01',
    ...
    content: (
      <ItemText
        content={[
          `Due to a tight deadline, it wasn’t feasible to realize all of the client’s
          ideas and wishes in the first version of the mobile application.`,
          `Together, we reviewed, discussed, and approved the proposed app features
          and software requirements for a minimum viable product (MVP).`,
        ]}
      />
    ),
  },
  {
    ...
    content: (
      <>
        <ItemList
          listTitle="The team that worked on the project at different times included:"
          list={[
  ...
  },
  {
    ...
    content: (
      <ItemText
        content={[
          `Along with user-facing applications, our team built a database to store receipts, products, and
          customer activity information. The analysis of this data enables marketers to personalize special offers,
          among other things.`,
          `Integration with the client’s internally developed customer relationship management (CRM) and
          enterprise resource planning (ERP) systems was challenging, but we worked out an architecture that
  ...
  },
  {
    ...
    content: (
      <ItemText
        content={[
          `Thanks to clear product requirements and Agile project management, the team delivered the planned
          MVP features on time, with few change requests and bug fixes. The team also performed usability testing
          and the necessary metadata, data quality, reference data, procedure, regression, integration, and performance
  ...
  },
  {
    ...
    content: (
      <ItemText
        content={[
          `In 2023, the client ordered an app upgrade: they updated their brand identity and loyalty program and were
          developing new trademarks and brands. Onix received a new brand style guide for Fayno Market developed by
...
export default phasesContentData;
