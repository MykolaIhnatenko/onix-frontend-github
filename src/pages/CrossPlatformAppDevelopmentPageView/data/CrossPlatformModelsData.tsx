...
const CrossPlatformModelsSectionData = {
  pageTitle: 'Onix Engagement Models',
  pageText: 'Choose a model that best suits you',
  data: modelsData,
};

export default CrossPlatformModelsSectionData;
